...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="mb-32 text-center">
    <h2 class="mb-32 text-3xl font-bold">
      Meet the <u class="text-primary text-purple-900 ">team</u>
    </h2>
    ...
    <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
        ...
        <div
          ...
          <div class="flex justify-center">
            <div class="flex justify-center -mt-[75px]">
              <img src="https://media-gru2-1.cdn.whatsapp.net/v/t61.24694-24/253835876_790860378544104_7302508549196102067_n.jpg?ccb=11-4&oh=01_Q5AaIFJrk2PtPNc_Tb6R6HgkggYs9Ek4jLEHLC5UAfjo-R_2&oe=663CFCCF&_nc_sid=e6ed6c&_nc_cat=100"
            ...
            <ul class="mx-auto flex list-inside justify-center">
              <a href="#!" class="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  ...
                  <path className="text-purple-900" fill="currentColor"
      ...
      <div class="mb-24 md:mb-0">
        <div
          ...
          <div class="flex justify-center">
            <div class="flex justify-center -mt-[75px]">
              <img src="https://media-gru2-1.cdn.whatsapp.net/v/t61.24694-24/120761504_2785771928325625_795667022293973308_n.jpg?ccb=11-4&oh=01_Q5AaIEBrWR5qkzcREhiP08bQoLsPDKdig0Ur4ctn93K_E84l&oe=663CD230&_nc_sid=e6ed6c&_nc_cat=102"
                class="mx-auto rounded-full shadow-lg dark:shadow-black/20 w-[150px]" alt="Avatar" />
            </div>
          </div>
          <div class="p-6">
      ...
      <div class="">
        <div
          ...
          <div class="flex justify-center">
            <div class="flex justify-center -mt-[75px]">
              <img src="https://media-gru2-1.cdn.whatsapp.net/v/t61.24694-24/416784742_751451286498934_4551746409454260304_n.jpg?ccb=11-4&oh=01_Q5AaIHiK6k7x1FJZwfBxvqKZHSYj6Nf2xrk1sHvFVSj8vyK_&oe=663CE00C&_nc_sid=e6ed6c&_nc_cat=106"
                class="mx-auto rounded-full shadow-lg dark:shadow-black/20 w-[150px]" alt="Avatar" />
            </div>
          </div>
          <div class="p-6">
